"""This file contains code for dpm-solver.

This file may have been modified by Bytedance Ltd. and/or its affiliates (“Bytedance's Modifications”).
All Bytedance's Modifications are Copyright (year) Bytedance Ltd. and/or its affiliates. 

Reference:
    https://github.com/baofff/U-ViT/blob/main/dpm_solver_pytorch.py
"""
...
class DPM_Solver:
    def __init__(self, model_fn, noise_schedule, predict_x0=False, thresholding=False, max_val=1., scaling_factor=-1):
    ...
    def model_fn(self, x, t):
        if self.predict_x0:
            ...
            # x0 = (x - sigma_t[(...,) + (None,)*dims] * noise[-1]) / alpha_t[(...,) + (None,)*dims]
